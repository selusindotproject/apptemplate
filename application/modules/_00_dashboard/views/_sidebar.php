<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <!-- dashboard -->
            <li><a href="<?php echo site_url() ?>"><i class="fa fa-circle text-light-blue"></i> <span>Dashboard</span></a></li>
            ...
            ">
                <a href="#">
                    <i class="fa fa-circle text-light-blue"></i> <span>Master</span>
            ...
            <ul class="treeview-menu">
            <li class="active"><a href="<?php echo base_url() ?>assets/adminlte/index.html"><i class="fa fa-circle-o"></i> Dashboard v1</a></li>
